...
public class EmployeeRepository {
	...
	public void update(Employee employee) {
		...
		String updateSql = "UPDATE employees SET id=:id,name=:name,image=:image,gender=:gender,hire_date=:hireDate,mail_address=:mailAddress,zip_code=:zipCode,address=:address,telephone=:telephone,salary=:salary,characteristics=:characteristics,dependents_count=:departmentCount WHERE id=:id";
